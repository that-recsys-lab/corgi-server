...
mastodon = Mastodon(
    api_base_url="https://hci.social", access_token="corgi_server.secret"
)
...
def get_home_timeline(headers=None, max_id=None, since_id=None, min_id=None, limit=20):
    ...
    home_timeline = mastodon.timeline_home(limit=5)
...
def get_hashtag_timeline(
    ...
    hashtag_timeline = mastodon.timeline_hashtag(hashtag=hashtag, limit=5)
...
def get_list_timeline(
    list_id, headers=None, max_id=None, since_id=None, min_id=None, limit=20
):
